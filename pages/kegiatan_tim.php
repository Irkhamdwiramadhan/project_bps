...
include '../includes/header.php'; // Pastikan header.php sudah memuat CSS Bootstrap Icons
...
<main class="main-content">
    <div class="header-content">
        <div class="d-flex justify-content-between align-items-center">
            <h2>KEGIATAN BERDASARKAN KABUPATEN/KOTA</h2>
    ...
    <div class="btn-action-group">
        ...
        <?php if ($has_access_for_action): ?>
            ...
            <a href="../proses/proses_hapus_kegiatan_tim.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-danger" title="Hapus Kegiatan" onclick="..."><i class="bi bi-trash"></i></a>
        <?php endif; ?>
    </div>
</td>
                                </tr>
                            ...
                            echo "<tr><td colspan='10' class='text-center p-5'>Tidak ada data kegiatan pada bulan dan tahun yang dipilih.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
