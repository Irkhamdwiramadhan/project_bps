...
<head>
    ...
    <style>
        ...
        :root {
            --sidebar-width: 240px;
            /* Sedikit lebih lebar untuk ruang */
            ...
            --accent-color: #00aaff;
            /* Biru elektrik yang lebih cerah */
        ...
        .sidebar-logo img {
            ...
            /* 0 atas, auto kanan-kiri, 10px bawah */
        ...
        <?php for ($i = 1; $i <= 10; $i++): ?>.sidebar-nav li:nth-child(<?php echo $i; ?>) {
        ...
        .nav-item.active::before {
            /* Indikator aktif tetap sama, sudah bagus */
        }
        ...
        /* Footer Sidebar */
        .sidebar-footer {
            /* Styling footer tetap sama, sudah kompak */
        }
        ...
        @media (max-width: 768px) {
            ...
            body.sidebar-open .sidebar-close-btn {
                right: 15px;
                /* Pindahkan tombol close ke dalam sidebar */
                opacity: 1;
            }
        }
    </style>
